...
incl = [15*pi/180,30*pi/180,45*pi/180,60*pi/180] #pi*4/18#1.5    # line of sight colatitude #in radians
# theta =  [15*pi/180,30*pi/180,45*pi/180,60*pi/180]# [pi/4]
# theta =  [3*pi/18]*4 #[15*pi/180,30*pi/180,45*pi/180,60*pi/180]# [pi/4]
theta =  [35*pi/180]*4 #[15*pi/180,30*pi/180,45*pi/180,60*pi/180]# [pi/4]
